...
<div class="form-group">
            JENIS
        <input type="text" id="jenis" name="jenis" class="form-control" required="" value="{{$data->jenis}}">
</div>
<div class="form-group">
            TINGKAT KEPEDASAN
        <textarea name="tingkat_kepedasan"  class="form-control" required=""> {{$data->alamat}}</textarea>
</div>
